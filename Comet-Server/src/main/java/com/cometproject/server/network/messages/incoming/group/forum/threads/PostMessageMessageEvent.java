    ...
    public void handle(Session client, MessageEvent msg) throws Exception {
        ...
        if (!client.getPlayer().getPermissions().getRank().roomFilterBypass()) {
            ...
            if (messageFilter.isBlocked()) {
                ...
                client.send(new NotificationMessageComposer("filter", Locale.get("game.message.blocked").replace("%s", messageFilter.getMessage())));
                return;
            ...
            if (subjectFilter.isBlocked()) {
                ...
                client.send(new NotificationMessageComposer("filter", Locale.get("game.message.blocked").replace("%s", subjectFilter.getMessage())));
                return;
