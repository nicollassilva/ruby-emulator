...
public class CheckValidNameMessageEvent implements Event {
    public void handle(Session client, MessageEvent msg) {
        ...
        final char[] letters = name.toLowerCase().toCharArray();
        final String allowedCharacters = "abcdefghijklmnopqrstuvwxyz.,_-;:?!1234567890";
        ...
        final FilterResult filterResult = RoomManager.getInstance().getFilter().filter(name);
