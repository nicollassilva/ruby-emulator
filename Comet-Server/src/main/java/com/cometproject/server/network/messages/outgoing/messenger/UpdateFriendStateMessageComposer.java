...
public class UpdateFriendStateMessageComposer extends MessageComposer {
    ...
    public void compose(IComposer msg) {
        ...
        msg.writeInt(this.group == null ? (this.playerAvatar.getGender().equalsIgnoreCase("M") ? 0 : 1) : 77);
        msg.writeBoolean(online);
        msg.writeBoolean(inRoom);
        msg.writeString(this.group != null ? this.group.getBadge() : (online ? this.playerAvatar.getFigure() : ""));
