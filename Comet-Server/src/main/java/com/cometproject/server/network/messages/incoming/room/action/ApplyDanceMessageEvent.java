...
import com.cometproject.server.game.rooms.objects.items.types.floor.wired.triggers.custom.WiredTriggerCustomStartsDancing;
...
public class ApplyDanceMessageEvent implements Event {
    public void handle(Session client, MessageEvent msg) {
        ...
        WiredTriggerCustomStartsDancing.executeTriggers(client.getPlayer().getEntity(), danceId);
    }
}
