    ...
    public void handle(Session client, MessageEvent msg) throws Exception {
        ...
        if (confirmed) {
            ...
            if (bothConfirmed) {
                ...
                leftPlayer.getPlayer().getSession().send(new LoveLockConfirmedMessageComposer(floorItem.getVirtualId()));
                rightPlayer.getPlayer().getSession().send(new LoveLockConfirmedMessageComposer(floorItem.getVirtualId()));
            }
        }
    }
}
