...
public class WiredConditionMemoryLessThanUser extends WiredConditionMemoryUser{
    public WiredConditionMemoryLessThanUser(RoomItemData roomItemData, Room room) {
