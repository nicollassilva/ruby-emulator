...
public class WiredActionMatchToSnapshot extends WiredActionItem {
    ...
    public void onEventComplete(WiredItemEvent event) {
        ...
        for (long itemId : this.getWiredData().getSelectedIds()) {
            ...
            if (this.getRoom().getItems().moveFloorItemWired(floorItem, !matchPosition ? currentPosition : newPosition, matchRotation ? itemSnapshot.getRotation() : floorItem.getRotation(), true, false)) {
