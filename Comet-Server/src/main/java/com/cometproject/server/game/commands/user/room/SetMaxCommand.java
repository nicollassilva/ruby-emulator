...
public class SetMaxCommand extends ChatCommand {
    ...
    public String getParameter() {
        return Locale.getOrDefault("command.parameter.amount", "(cantidad)");
    }

    @Override
    public String getDescription() {
        return Locale.getOrDefault("command.setmax.description", "Establece la máxima cantidad de usuarios en tu sala");
    }
}
