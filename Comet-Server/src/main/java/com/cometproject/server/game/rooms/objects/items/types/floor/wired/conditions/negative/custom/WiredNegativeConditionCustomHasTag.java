...
public class WiredNegativeConditionCustomHasTag extends WiredConditionCustomHasRank {

    public WiredNegativeConditionCustomHasTag(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
}
