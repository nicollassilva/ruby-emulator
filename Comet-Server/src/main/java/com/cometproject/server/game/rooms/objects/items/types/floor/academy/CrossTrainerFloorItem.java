...
public class CrossTrainerFloorItem extends RoomItemFloor {
    private final int effectId;

    public CrossTrainerFloorItem(RoomItemData itemData, Room room) {
        super(itemData, room);
    ...
    public void onEntityStepOn(RoomEntity entity) {
        ...
        if(PlayerManager.getInstance().isOnline(playerId)) {
            ...
            if (session != null && session.getPlayer() != null && session.getPlayer().getAchievements() != null) {
                session.getPlayer().setInCrossTrainer(true);
            }
        }
    ...
    public void onEntityStepOff(RoomEntity entity) {
        ...
        session.getPlayer().setInCrossTrainer(false);
