...
public class InstanceStatsCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        message.append("Build: ").append(Comet.getBuild()).append("<br><br>");
        message.append("<b>Game Statistics</b><br>Players online: ").append(PlayerManager.getInstance().size()).append("<br>Active rooms: ").append(RoomManager.getInstance().getRoomInstances().size()).append("<br><br>");
