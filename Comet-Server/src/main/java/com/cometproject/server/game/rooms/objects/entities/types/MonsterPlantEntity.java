...
public class MonsterPlantEntity extends PetEntity {
    ...
    public void breed(MonsterPlantEntity plant) {
        ...
        if (plantData.canBreed() && thisData.canBreed()) {
            ...
            final int fatherSeedRarity = thisData.getSeedRarity();
            final int motherSeedRarity = plantData.getSeedRarity();
            final int seedRarity = Math.min(fatherSeedRarity, motherSeedRarity);

            final int seedItemId = CometSettings.monsterSeedId;
