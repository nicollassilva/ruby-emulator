...
public class SnowWarArena9 extends SnowWarArenaBase {
    public SnowWarArena9() {
        ...
        Item.Rot = 1;
        Item.Z = 0;
        Item.extraData = new MapStuffData("state=0\toffsetX=-1070\toffsetZ=9920\toffsetY=1520\timageUrl=" + Locale.getOrDefault("snowwar_arena9", "https://staff.pixelhotel.es/swf/games/gamecenter_snowwar/snst_bg_2_big.png"));
        fuseObjects.add(Item);
