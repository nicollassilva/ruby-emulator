...
public class RoomItemFactory {
    ...
    static {
        ...
        itemDefinitionMap = new HashMap<String, Class<? extends RoomItemFloor>>() {{
            ...
            put("wf_cstm_keyword_exclude", WiredTriggerCustomKeywordExclude.class); // excluye clave
            put("wf_cstm_keyword_not_is", WiredTriggerCustomKeywordNotIs.class); // no es clave
            put("wf_cstm_add_tag", WiredCustomAddTag.class); // add tagg / on tagg
            put("wf_cstm_teleport_item", WiredCustomTeleportItem.class); // teleport item bajo tuyo
            put("wf_cstm_teleport_item_front", WiredCustomTeleportFront.class); // teleport item infront
            put("wf_cstm_remove_tag", WiredCustomRemoveTag.class); // remove tag
            put("wf_cstm_close_dices", WiredCustomCloseDices.class); // close dices
            put("wf_cstm_trg_starts_dancing", WiredTriggerCustomStartsDancing.class); // usuario comienza a danzar
            put("wf_cstm_show_video_youtube", WiredCustomShouVideoYoutube.class); // new wired
            put("wf_cstm_cnd_has_rights", WiredConditionCustomHasRights.class); // tiene permisos en sala
            put("wf_cstm_cnd_ngt_has_rights", WiredNegativeConditionCustomHasRights.class); // no tiene permisos en sala
            put("wf_cstm_reset_timers_afk", WiredCustomResetTimerAfk.class); // new wired
            ...
            put("wf_xtra_no_effect_items", WiredAddonNoItemsAnimateEffect.class); // new wired
            //put("wf_xtra_no_effect_players", WiredAddonNoPlayersAnimateEffect.class); // new wired
            put("wf_cstm_move_and_rotate_base", WiredActionMoveRotateBase.class); // new wired
            put("wf_cstm_tridirectional", WiredActionSlideItem.class); // new wired
            //put("wf_cstm_trigger_command_affec", WiredTriggerCustomUserSaysCommandAffected.class); // test
            put("wf_cstm_user_move", WiredCustomUserMove.class); // mover usuario a furni
            ...
            //put("fishing_pool", FishingPoolFloorItem.class); // work
            //put("buy_items_fishing", BuyItemsPescaFloorItem.class); // test
