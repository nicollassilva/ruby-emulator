...
public class WiredCustomForceCollisionNoCenter extends WiredActionItem {

    public WiredCustomForceCollisionNoCenter(RoomItemData itemData, Room room) {
        super(itemData, room);
    }
    ...
    private boolean isCollided(RoomEntity entity, RoomItemFloor floorItem) {
        boolean tilesTouching = entity.getPosition().equals(floorItem.getPosition());

        if (!tilesTouching && entity.getPosition().touching(floorItem.getPosition())) {
