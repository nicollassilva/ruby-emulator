...
public class SnowWarArena11 extends SnowWarArenaBase {
    public SnowWarArena11() {
        ...
        Item.Rot = 1;
        Item.Z = 0;
        Item.extraData = new MapStuffData("state=0\toffsetX=-1119\toffsetZ=9950\toffsetY=390\timageUrl=" + Locale.getOrDefault("snowwar_arena11", "https://staff.pixelhotel.es/swf/games/gamecenter_snowwar/snst_bg_3_noscale.png"));
        fuseObjects.add(Item);
