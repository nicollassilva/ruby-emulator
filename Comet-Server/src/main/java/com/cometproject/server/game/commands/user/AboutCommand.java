...
public class AboutCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] message) {
        ...
        if (CometSettings.aboutShowRoomsActive || CometSettings.aboutShowUptime || aboutDetailed) {
            ...
            about.append("<br>").append(Locale.getOrDefault("command.about.credits_title", "<b>Agradecimentos:</b>")).append("<br>Leon (Criador)<br>iNicollas<br>Djinn<br>Snaiker<br>darkdev");
