...
public class SnowWarArena8 extends SnowWarArenaBase {
    public SnowWarArena8() {
        ...
        Item.Rot = 1;
        Item.Z = 0;
        Item.extraData = new MapStuffData("state=0\toffsetX=-1166\toffsetZ=10000\toffsetY=1542\timageUrl=" + Locale.getOrDefault("snowwar_arena8", "https://staff.pixelhotel.es/swf/games/gamecenter_snowwar/snst_bg_1_a_big.png"));
        fuseObjects.add(Item);
