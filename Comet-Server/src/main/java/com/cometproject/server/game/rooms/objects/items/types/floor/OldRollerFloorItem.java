...
public class OldRollerFloorItem extends AdvancedFloorItem<RollerFloorItemEvent> {
    ...
    public OldRollerFloorItem(RoomItemData itemData, Room room) {
        super(itemData, room);
