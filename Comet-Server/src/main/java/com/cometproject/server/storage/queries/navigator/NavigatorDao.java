...
public class NavigatorDao {
    ...
    public static void insertPublicRoom(int roomId, String caption, String description) {
        Connection sqlConnection = null;
        PreparedStatement preparedStatement = null;

        try {
            sqlConnection = SqlHelper.getConnection();
            preparedStatement = SqlHelper.prepare("INSERT into navigator_publics VALUES(?, ?, ?, ?, ?, ?, ?)", sqlConnection);

            preparedStatement.setInt(1, roomId);
            preparedStatement.setString(2, caption);
            preparedStatement.setString(3, description);
            preparedStatement.setString(4, "navigator-thumbnail/" + roomId + ".png");
            preparedStatement.setInt(5, 1); // todo: make this dynamic
            preparedStatement.setString(6, "1");
            preparedStatement.setString(7, "official-root"); // todo: also make this dynamic ...?
    ...
    public static void removePublicRoom(int roomId) {
        Connection sqlConnection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            preparedStatement = SqlHelper.prepare("DELETE FROM navigator_publics WHERE room_id = ?", sqlConnection);
            preparedStatement.setInt(1, roomId);
