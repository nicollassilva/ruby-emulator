...
public class RoomDataFactory {
    ...
    public IRoomData createRoomData(int id, RoomType type, String name, String description, int ownerId, String owner,
                                    ...
                                    String originalPassword, RoomTradeState tradeState, int creationTime, int score, String[] tags,
                                    ...
                                    String thumbnail, boolean wiredHidden, int userIdleTicks, int rollerSpeedLevel, boolean rollerSpeed, boolean wiredLimit, boolean roomDiagonal, int songId) {
